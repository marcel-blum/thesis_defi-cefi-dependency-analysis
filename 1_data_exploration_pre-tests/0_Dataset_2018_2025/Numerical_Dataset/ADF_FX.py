...
fx_results_form = to_apa_latex_table(
    fx_results_df,
    "Augmented Dickey-Fuller Test: Foreign Exchange Rate Log Returns",
    "tab:adffx",
...
plot_time_series(
    ...
    ylabel="Log Return",
    figure_title="Log Returns of Foreign Exchange Rate Pairs",
    figure_note="Daily log returns computed from mid prices retrieved via Refinitiv API.",
