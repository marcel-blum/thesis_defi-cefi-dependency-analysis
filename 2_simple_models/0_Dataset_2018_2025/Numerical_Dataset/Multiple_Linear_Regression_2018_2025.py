...
# PATHS
# ─────────────────────────────────────────────
INPUT_PATH  = "/Users/marcel/PycharmProjects/Master_Thesis_Pavia/0_data/0_Dataset_2018_2025/Final_Dataset_numTVL_2018_2025.csv"
OUTPUT_PATH = "/Users/marcel/PycharmProjects/Master_Thesis_Pavia/2_simple_models/0_Dataset_2018_2025/Tables_Figures"
...
TARGET   = "Global_TVL_USD_log_return_w"
...
# ─────────────────────────────────────────────
# HELPER: SIGNIFICANCE STARS / 4-DECIMAL FORMATTING
# ─────────────────────────────────────────────
def sig_stars(p):
    if p < 0.01:  return "***"
    elif p < 0.05: return "**"
...
with open(f"{OUTPUT_PATH}/mlrcoef_HC3_20182025.tex", "w") as f:
    f.write(coef_tex)
...
with open(f"{OUTPUT_PATH}/white_test_20182025.tex", "w") as f:
    f.write(white_tex)
...
plt.tight_layout()
plt.savefig(f"{OUTPUT_PATH}/mlr_actual_vs_predicted_test_20182025.png", dpi=300, bbox_inches="tight")
plt.close()
